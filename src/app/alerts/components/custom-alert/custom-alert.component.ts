...
export class CustomAlertComponent {
  ...
  getWellDropdown() {
    this.CustomAlertService.getWellName().subscribe((res) => {
      this.well = res;
  ...
  getAlertDetails() {
    ...
    this.CustomAlertService.displayDetails().subscribe((res) => {
      this.alertData = res;
  ...
  editAlert(Id: number) {
    ...
    if (GetRecord != null) {
      ...
      this.customAlertForm.controls.CustomAlertName.setValue(
        GetRecord[0].customAlertName
      );
      this.customAlertForm.controls.wellName.setValue(GetRecord[0].wellName);
      this.customAlertForm.controls.NotificationType.setValue(
        GetRecord[0].notificationType
      );
      this.customAlertForm.controls.NotificationType.setValue(
        GetRecord[0].notificationType
      );
      ...
      this.customAlertForm.controls.Value.setValue(
        GetRecord[0].value.toString()
      );
    }
  }
